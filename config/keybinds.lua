...
-- I customized this to use the numpad instead
for i = 1, 9 do
    ...
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Control" }, "#" .. np_map[i],
                  ...
                  {description = "toggle tag #" .. np_map[i], group = "tag"}),
        -- Move client to tag.
        awful.key({ modkey, "Shift" }, "#" .. np_map[i],
                  ...
                  {description = "move focused client to tag #".. np_map[i], group = "tag"}),
        ...
        awful.key({ modkey, "Control", "Shift" }, "#" .. np_map[i],
                  ...
                  {description = "toggle focused client on tag #" .. np_map[i], group = "tag"})
    )
end
